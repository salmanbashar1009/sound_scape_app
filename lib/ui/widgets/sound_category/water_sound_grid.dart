...
class WaterSoundGrid extends StatelessWidget {
      ...
      return Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: searchIconController.isSelected
              ...
              : (SoundTileList().waterSoundTiles.length),
          itemBuilder: (context, index) {
            return GetBuilder<PlayToggleButtonController>(builder: (context) {
              return searchIconController.isSelected ? Get.find<FilterController>().allFilteredSoundTile[index] :  SoundTileList().waterSoundTiles[index];
            });
          },
        ),
      );
