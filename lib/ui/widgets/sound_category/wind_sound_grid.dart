...
class WindSoundGrid extends StatelessWidget {
  WindSoundGrid({super.key});
      ...
      return Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: searchIconController.isSelected
              ...
              : (SoundTileList().windSoundTiles.length),
          itemBuilder: (context, index) {
            return GetBuilder<PlayToggleButtonController>(builder: (context) {
              return searchIconController.isSelected ? Get.find<FilterController>().allFilteredSoundTile[index] : SoundTileList().windSoundTiles[index];
            });
          },
        ),
      );
